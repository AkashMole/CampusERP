                ...
                <div class="row">
                    ...
                    <div class="col-md-4 my-auto">
                        <div class="card card-primary">
                            <div class="card-body">
                                <h5 class="text-dark text-center">QuizzApp | Staff Login</h5>
                                <hr>
                                <div id="login">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on("click", "#submit", function() {
                ...
                var dataString = "type=staffLogin&Browser=" + Browser + "&log=" + log + "&username=" + $("#username").val() + "&password=" + $("#password").val();
                ...
                $.ajax({
                    ...
                    success: function(statusVar) {
                        ...
                        if ($.trim(result[0]) == "ok") {
                            window.location.href = "./dashboard.prof.php";
