$(document).ready(function () {
  function checkBrowser() {
    ...
    if (Browser == "Other") {
      $("#browser").text(
        " Your Browser is not Chromium Based. Please Change your browser to continue. "
      );
      ...
      $("#browser").text(
        " Your Browser is Chromium Based. You can start Exam."
      );
  ...
  $("#startExamBtn").on("click", function (e) {
    var dataString =
      "type=setMCQExamSession&exam_id=" + $("#examModalExamID").html();
    $.ajax({
      type: "POST",
      ...
      success: function (outputData) {
        ...
        if (outputData == "OK") {
          ...
          var strWindowFeatures =
            'channelmode="yes",location="no",menubar="no",status="yes",fullscreen="yes"';
