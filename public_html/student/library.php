                        ...
                        <div class="card timeline card-primary shadow mt-3">
                            ...
                            <div class="card-body" data-simplebar style="max-height:70vh; overflow-y: auto; overflow-x: hidden;">
                                <div class="row mx-1" id="booksView">
                                    ...
                                    ?>
                                    <div class="col-md-2 col-6 p-1 singleBook" style="max-height:30vh">
                                        <div class="card border-0">
                                            <div class="card-body p-1 text-center single-book text-dark">
                    ...
                    <div class="col-md-2 col-12 m-0 p-0">
                        <div class="card shadow mt-3">
                            <div class="card-body p-2">
                                <h6 class="text-center">RD's SCSCOE, Bhor.</h6>
                                <img src="./assets/img/<?php echo $student_info['profile_path']; ?>" class="img-fluid rounded p-2">
                                <h6 class="text-center">Akash Mole</h6>
                                <img src="https://www.pngmart.com/files/10/Barcode-PNG-Pic.png" class="img-fluid rounded px-4">
                            </div>
                        </div>
                    </div>
                </div>
